import os
import argparse
from src.model import EDDM as network
...
parser.add_argument("--dataset", default="BSD", help="Dataset need to be tested. (BSD, Kodak, Urban or Set?)")
...
DATA_SET = {"BSD": "./data/BSD-100", "Kodak": "./data/Kodak-24", "Urban": "./data/Urban-100", "Set": "./data/Set-12"}[args.dataset]
DATA_BIN = {"BSD": "./bin/BSD-100", "Kodak": "./bin/Kodak-24", "Urban": "./bin/Urban-100"}[args.dataset]
TEST = args.test_model
SIGMA = args.sigma
PIC_NUM = args.test_pic_num
SHOW = args.pic_show
SAVE = args.pic_save
WEIGHT_PATH = {"BSD": "./model/BSD-100/", "Kodak": "./model/Kodak-24/", "Urban": "./model/Urban-100/"}[args.dataset] + 'model_weights_{}.h5'.format(SIGMA)
SAVE_PATH = {"BSD": "./fig/BSD-100", "Kodak": "./fig/Kodak-24", "Urban": "./fig/Urban-100"}[args.dataset]
